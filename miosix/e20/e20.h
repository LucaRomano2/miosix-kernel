...
public:
    ...
    PriorityEventQueueBasic(const PriorityEventQueueBasic&) = delete;
    PriorityEventQueueBasic& operator= (const PriorityEventQueueBasic&) = delete;
